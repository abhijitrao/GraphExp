...
public class PieChartExp extends BaseActivity implements OnChartValueSelectedListener {
	...
	public void onSaveClick(View v) {
		...
		test.setText(result);
		 if (mChart.saveToGallery("title" + System.currentTimeMillis(), 100)) {
             Toast.makeText(PieChartExp.this, "Saving SUCCESSFUL!",
                     Toast.LENGTH_SHORT).show();
         } else
             Toast.makeText(PieChartExp.this, "Saving FAILED!", Toast.LENGTH_SHORT)
                     .show();
	}
...
//			xVals.add(mMonths[i % mMonths.length]);
	...
	private SpannableString generateCenterSpannableText() {
		...
		SpannableString s = new SpannableString("Share Market\ndeveloped by Abhijit Ku Rao");
	...
	public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
		...
		if (e == null)
			return;
		showToast("xPosition: " + e.getXIndex()+" Value: " + e.getVal());
		String Item=mMonths[e.getXIndex()];
		Intent ob=new Intent(PieChartExp.this,PieChartDetailActivity.class);
		ob.putExtra("getVal",String.valueOf(e.getVal()));
		ob.putExtra("ItemName", Item);
		startActivity(ob);
